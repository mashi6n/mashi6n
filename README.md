...
AI is making my brain smooth.

## Repositories
### [kyounoryouri-tools](https://github.com/mashi6n/kyounoryouri-tools)
- A collection of utilities to download and extract recipe data from Minna no Kyō no Ryōri, a cooking recipe website operated by Japan Broadcasting Corporation (NHK).
- Related to the paper "[A Highly Clean Recipe Dataset with Ingredient States Annotation for State Probing Task](https://doi.org/10.1145/3746027.3755771)" accepted at ACMMM 2025.

### [cudep-web](https://github.com/mashi6n/cudep-web)
- A simple web application that helps you resolve dependencies for CUDA, GPUs and GPU drivers.

## Book Records
Here are some books I've read. (I keep a record of books I've read for continuous self-learning.)
...
- [Learning Go](https://www.oreilly.co.jp/books/9784814401192/)
- [Programming Rust](https://www.oreilly.co.jp/books/9784873119786/)
...
- [Go言語 100Tips](https://book.impress.co.jp/books/1122101133)
- [Rustの練習帳](https://www.oreilly.co.jp/books/9784814400584/)
- [Effective Python](https://www.oreilly.co.jp/books/9784814401338/)

**Wishlist**
- [ソフトウェアエンジニアガイドブック](https://www.oreilly.co.jp/books/9784814401215/)
...
- [作って理解する仮想化技術](https://gihyo.jp/book/2025/978-4-297-15012-9)
